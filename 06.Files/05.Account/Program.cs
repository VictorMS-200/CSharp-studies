...
var pathFile = Path.Combine(Environment.CurrentDirectory, "06.Files/05.Account/Accounts.txt");
var pathName = Path.Combine(Environment.CurrentDirectory, "06.Files/05.Account/Name.txt");
...
void FileClass()
{
    ...
    File.WriteAllText(pathName, "Victor Martins");
}
