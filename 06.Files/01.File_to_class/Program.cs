...
var path = Path.Combine(Environment.CurrentDirectory, "06.Files/01.File_to_class/Accounts.txt"); // Combining the path of the current directory with the name of the file


// Open file (Accounts.txt) and read line by line
using (var file = new FileStream(path, FileMode.Open)) // Accounts.txt is in the root folder of the project (06. Files\01. File to class)
{
    // Read file
